...
<%@page import="com.hotelmanagement.dto.UserBean, com.hotelmanagement.dto.RoomDetailsBean, java.util.ArrayList, java.util.Iterator" %>
		...
		<table align="center">
			...
			%>
				<tr>
					...
					<td><button type="submit" value="<%=i%>" name="submit">Delete</button></td>
				</tr>
			<%
				i++;
				}
			...
			%>
			<input type="hidden" name="delete" value="room"/>
		</table><br><br>
